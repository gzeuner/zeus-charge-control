 ...
 * ...
 *
 * Periodically refreshes market prices, persists them, and triggers scheduling recalculation.
 * Acts as the integration point between price providers and the charging optimizer.
 */
@Service
public class DataManagementService {
     ...
     */
    @PostConstruct
    @Scheduled(cron = "${scheduled.job.cron:0 15 14,22,2 * * *}")
